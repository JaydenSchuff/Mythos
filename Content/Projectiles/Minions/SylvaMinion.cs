...
namespace Mythos.Content.Projectiles.Minions
{
    public class SylvaMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<SylvaMinionBuff>());
                return;
            }

            if(owner.HasBuff(ModContent.BuffType<SylvaMinionBuff>())) {
